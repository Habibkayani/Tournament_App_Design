...
import Adapters.PastOrganizerListViewAdapter;
import Data.Tournament;


public class Organizer_Past extends Fragment {

    private RecyclerView recyclerView;
    private PastOrganizerListViewAdapter recyclerViewAdapter;
    private List<Tournament> tournamentList;
    private RequestQueue queue;
    LinearLayoutManager manager;
    private final String JSON_URL = "https://gist.githubusercontent.com/aws1994/f583d54e5af8e56173492d3f60dd5ebf/raw/c7796ba51d5a0d37fc756cf0fd14e54434c547bc/anime.json";
    private JsonArrayRequest request;
    public PastOrganizerListViewAdapter adapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_organizer__past, container, false);
    }
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.lrecyler3);
    ...
    private void jsonrequest() {  request = new JsonArrayRequest(JSON_URL, new Response.Listener<JSONArray>() {
        ...
        public void onResponse(JSONArray response) {
            ...
            adapter = new PastOrganizerListViewAdapter(getContext(),tournamentList);
